...
class QRspec {
	...
	public static function debug($frame, $binary_mode = false) {
		if ($binary_mode) {
			...
			foreach ($frame as &$frameLine) {
				$frameLine = strtr($frameLine, [
					"\xc0" => '<span class="m">&nbsp;</span>',
					"\xc1" => '<span class="m">&#9618;</span>',
					"\xa0" => '<span class="p">&nbsp;</span>',
					"\xa1" => '<span class="p">&#9618;</span>',
					"\x84" => '<span class="s">F</span>',
					"\x85" => '<span class="s">f</span>',
					"\x81" => '<span class="x">S</span>',
					"\x90" => '<span class="c">C</span>',
					"\x91" => '<span class="c">c</span>',
					"\x88" => '<span class="f">&nbsp;</span>',
					"\x89" => '<span class="f">&#9618;</span>',
					"\x03" => '1',
					"\x02" => '0'
				]);
			}                
